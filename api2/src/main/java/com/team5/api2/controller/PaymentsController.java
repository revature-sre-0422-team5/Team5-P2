...
import com.team5.api2.entities.OrderCostCalculationEntity;
...
public class PaymentsController {
    ...
    public ResponseEntity <OrderCostCalculationEntity> getJourneyCost (@RequestBody OrderCostRequest ocr){
        try {
            return ResponseEntity.ok().body(new OrderCostCalculationEntity(1234));
        }
        catch (Exception e){
            e.printStackTrace();
